  ...
  const onSubmit = async (data) => {
    ...
    try {
      await addDoc(collection(db, "posts"), {
        ...
        author: displayName || currentUser.email,
    ...
    <div className="py-8 sm:py-10">
      <div className="max-w-lg mx-auto bg-white px-4 py-4 sm:px-6 sm:py-6 rounded-xl shadow-lg">
        ...
        >
          ...
          <button
            type="submit"
            className="w-full text-sm sm:text-base md:text-lg cursor-pointer bg-gradient-to-r from-blue-500 to-teal-400 text-white p-2 sm:p-3 rounded-lg shadow-md hover:shadow-lg transform hover:-translate-y-1 transition-all duration-200"
          >
            Đăng bài
          </button>
        </form>
